...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    BlackjackRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const BlackjackScreen(),
      );
    },
...
/// generated route for
/// [BlackjackScreen]
class BlackjackRoute extends PageRouteInfo<void> {
  const BlackjackRoute({List<PageRouteInfo>? children})
      : super(
          BlackjackRoute.name,
          initialChildren: children,
        );

  static const String name = 'BlackjackRoute';
